...
✅ **Configuração pronta para devs** - Ambiente de desenvolvimento pré-configurado para evitar instalar drivers ou criar seus próprios `docker-compose` 
inicie bancos rapidamente com scripts ou profiles prontos.
